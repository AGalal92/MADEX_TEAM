  ...
  return (
    ...
    >
      <div className="container-fluid container-xl position-relative d-flex align-items-center">
        ...
        <nav id="navmenu" className="navmenu">
          <ul className="no-underline">
            {headerData.navLinks.map((link) => (
              <li key={link.id} className="no-underline">
                <Link
                  style={{ textDecoration: 'none' }}
                  href={link.href}
                  className={activeSection === link.id ? 'active underline' : 'no-underline'}
                >
                  {link.label}
                </Link>
              </li>
        ...
        <Link href={headerData.ctaButton.href} className="cta-btn no-underline">
